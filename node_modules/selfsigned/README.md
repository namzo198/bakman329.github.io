...
var pems = selfsigned.generate(null, {
  ...
  clientCertificateCN: 'jdoe' // client certificate's common name (default: 'Alex Doe jdoe123')
});
```
...
To override the default client CN of `Alex doe jdoe123`, add another option for `clientCertificateCN`:
